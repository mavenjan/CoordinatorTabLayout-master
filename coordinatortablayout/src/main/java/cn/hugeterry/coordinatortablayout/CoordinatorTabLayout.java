...
public class CoordinatorTabLayout extends CoordinatorLayout {
     ...
     * @return CoordinatorTabLayout
     */
    public CoordinatorTabLayout setTabBackgroundColor(int color) {
     ...
     * 设置指示器下标高度
     *
     * @param height 指示器高度 （0dp为隐藏）
     * @return CoordinatorTabLayout
     */
    public CoordinatorTabLayout setIndicatorHeight(int height) {
     ...
     * @return CoordinatorTabLayout
     */
    public CoordinatorTabLayout setIndicatorColor(int color) {
        mTabLayout.setSelectedTabIndicatorColor(color);
        return this;
    }

    /**
     * 设置每个tab选中字体颜色和未选中字体颜色
     *
     * @param normalColor   未选中字体颜色
     * @param selectedColor 选中字体颜色
     * @return CoordinatorTabLayout
     */
    public CoordinatorTabLayout setTabTextColor(int normalColor, int selectedColor) {
     ...
     * 设置每个tab选中字体颜色和未选中字体颜色
     *
     * @param textColor   未选中字体颜色
     * @return CoordinatorTabLayout
     */
    public CoordinatorTabLayout setTabTextColor(ColorStateList textColor) {
     ...
     * @return CoordinatorTabLayout
     */
    public CoordinatorTabLayout setTabIcon(int resId) {
     ...
     * @return CoordinatorTabLayout
     */
    public CoordinatorTabLayout setTabIcon(Drawable icon) {
        mTabLayout.addTab(mTabLayout.newTab().setIcon(icon));
        return this;
    }
     ...
     * @param bottom padding Bootom
     * @return CoordinatorTabLayout
     */
    public CoordinatorTabLayout setTabPadding(int left, int top, int right, int bottom) {
     ...
     * 设置Tab的padding值
     *
     * @param start paddingLeft
     * @param top paddingTop
     * @param end paddingRight
     * @param bottom padding Bootom
     * @return CoordinatorTabLayout
     */
    public CoordinatorTabLayout setTabLayoutPadding(int start, int top, int end, int bottom) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            mTabLayout.setPaddingRelative(start, top, end, bottom);
        }
        return this;
    }
